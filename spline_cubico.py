...
plt.title("Puntos equiespaciados vs no equiespaciados para Splines")
plt.plot([int(k) for k in range(2,21)], ev_error_splines_equiespaciados(coords_x, coords_y), label="Error promedio con puntos equiespaciados")
plt.plot([int(k) for k in range(2,21)], errores_promedio(coords_x, coords_y), label="Error promedio por puntos no equiespaciados")
